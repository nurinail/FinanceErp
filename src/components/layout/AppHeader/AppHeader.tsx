...
const AppHeader = () => {
  ...
  const historyLenght = useSelector(
      ...
      <Space className="appHeader_nav">
        <div
          className={classNames(
            isModal ? "appHeader_nav_modal" : "none_active"
          )}
        >
          <p className="appHeader_nav_modal_title">
            Çıxmaq istədiyinə əminsinizmi?
          </p>
          <div className="appHeader_nav_modal_buttons">
            <button
              onClick={logOut}
              className="appHeader_nav_modal_buttons_item"
            >
              Bəli
            </button>
            <button
        ...
        <button
          ...
          className="appHeader_nav_logout"
        >
          <CiLogout />
        </button>
